...
| E04 - Freeze a useful control corpus | In progress; Q10.a complete | Primary-source review selected OpenStax *Principles of Economics 2e*, book-specific CC BY 4.0, PDF revision `PE2-2017-002-(03/18)-LC`; WikiText is rejected over unresolved item-level license/attribution, and PG-19 is too large for the first bounded local baseline. No source has been downloaded. Q10.b must verify hash and text-only license scope, then freeze document-level train/validation/test identities. |
