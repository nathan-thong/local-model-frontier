...
- **Current priority:** The C0 implementation, correctness and CPU resource reference are complete at `502014799903fc9500cebf109acc05eed8ba2e5c`; see [`s06_linear_reference_result_v1.json`](s06_linear_reference_result_v1.json). S06-DP-001 is preregistered in `configs/s06/s06_dependency_screen.json`; implement and validate its deterministic generator and capped runner before executing. Do not begin architecture-comparison training until that gate passes.
